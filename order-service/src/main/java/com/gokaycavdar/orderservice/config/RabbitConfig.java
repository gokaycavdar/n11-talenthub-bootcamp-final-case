...
public class RabbitConfig {
    ...
    @Bean
    public Queue paymentSuccessQueue(@Value("${order.payment.success-queue}") String queueName) {
        return new Queue(queueName, true);
    }

    @Bean
    public Queue paymentFailedQueue(@Value("${order.payment.failed-queue}") String queueName) {
        return new Queue(queueName, true);
    }
